...
class BlendedLatnetDiffusion:
    ...
    def parse_args(self):
        ...
        parser.add_argument(
            "--prompt", type=str,help="The target text prompt",
            default="A cat"
        )
        parser.add_argument(
            "--init_image", type=str,  help="The path to the input image",
            default="dataset_mixed/beach/0.jpg"
        )
        parser.add_argument(
            "--mask", type=str, help="The path to the input mask",
            default="dataset_mixed/mask.png"
        )
        parser.add_argument(
            "--model_path",
            type=str,
